...
def get_recommendations(user_query, top_n, system_msg, stock_items_df, model="gpt-4o"):
    ...
    payload = {
        ...
        "stock_items": _to_records(stock_items_df, max_items=200),  # tune this
        "n": int(top_n)
    }
...
def main():
    ...
    * Get top-rank products Are highly related to your product.
    ...
    if search:
            ...
            #shortlisted_stock=get_vector_recommendations(user_intent,vec_db,top_n)
            ...
            top_n = 5
            results=get_recommendations(user_intent,top_n,system_msg,stock_items,model="gpt-4o")
